                    ...
                    <div className="flex gap-2 pt-2 sm:pt-3 border-t border-border dark:border-slate-700">
                      {status !== 'completed' && (
                        <button
                          ...
                          className="flex-1 px-2 py-1 text-xs bg-primary/10 dark:bg-primary/20 text-primary dark:text-accent hover:bg-primary/20 dark:hover:bg-primary/30 rounded font-medium transition-colors whitespace-nowrap"
                        >
        ...
        <div className="bg-card dark:bg-slate-900/60 border border-border dark:border-slate-800 rounded-2xl p-4 sm:p-6 shadow-lg">
          ...
          <div className="space-y-2 sm:space-y-3 max-h-[300px] sm:max-h-none overflow-y-auto">
            {scheduleItems
              ...
              .slice(0, 5)
              .map((item, idx) => (
                <div key={item.id} className="flex items-center gap-2 sm:gap-3 pb-2 sm:pb-3 border-b border-border/50 dark:border-slate-700/50 last:border-b-0">
