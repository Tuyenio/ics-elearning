        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full mb-4 font-semibold">
                <Lock size={16} />
                <span className="text-sm">{t("forgot_badge", "Khôi Phục Mật Khẩu")}</span>
              </div>
              <h1 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white mb-3">{t("forgot_title", "Quên Mật Khẩu?")}</h1>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">
                {t("forgot_desc", "Đừng lo lắng! Nhập email của bạn và chúng tôi sẽ gửi liên kết đặt lại mật khẩu")}
              </p>
            </motion.div>
          </div>
            ...
            <div className="relative bg-white dark:bg-slate-900/95 border border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
              ...
              <div className="flex items-center justify-center gap-2 mb-6 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800">
                ...
                <span className="text-sm font-semibold text-blue-900 dark:text-blue-300">
                  {t("forgot_security_badge", "Liên kết khôi phục được mã hóa và an toàn")}
                </span>
              </div>
              ...
              <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-6">
                {t("forgot_remember", "Nhớ mật khẩu?")}{" "}
          ...
          >
            <div className="flex items-center gap-3 p-4 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl">
              ...
              <div>
                <div className="text-xs font-bold text-slate-900 dark:text-white">{t("forgot_check_email", "Kiểm tra email")}</div>
                <div className="text-xs text-slate-600 dark:text-slate-400">{t("forgot_in_5min", "Trong 5 phút")}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-4 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl">
              <Sparkles size={20} className="text-purple-600 dark:text-purple-400" />
              <div>
                <div className="text-xs font-bold text-slate-900 dark:text-white">{t("forgot_support_247", "Hỗ trợ 24/7")}</div>
                <div className="text-xs text-slate-600 dark:text-slate-400">{t("forgot_contact_admin", "Liên hệ admin")}</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {t("forgot_terms_agree", "Bằng cách sử dụng dịch vụ, bạn đồng ý với")}{" "}
