          ...
          <div className="text-center mb-8">
            ...
            >
              <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-shadow">
                  <GraduationCap className="text-white" size={32} />
                </div>
                <span className="font-black text-2xl bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                  ICS Learning
                </span>
              </Link>
            </motion.div>
