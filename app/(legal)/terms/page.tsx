    ...
    <div className="relative min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-20 pb-12">
        ...
        >
          ...
          <p className="mt-3 text-white/90 max-w-2xl">
            ...
            và điều kiện được nêu dưới đây nhằm đảm bảo môi trường học tập an toàn,
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <aside className="lg:col-span-3">
          <div className="sticky top-24 bg-white rounded-2xl border border-gray-200 p-5">
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="#acceptance" className="hover:text-primary">Chấp nhận điều khoản</a></li>
              <li><a href="#account" className="hover:text-primary">Tài khoản người dùng</a></li>
              <li><a href="#usage" className="hover:text-primary">Quy tắc sử dụng</a></li>
              <li><a href="#violations" className="hover:text-primary">Vi phạm & xử lý</a></li>
              <li><a href="#changes" className="hover:text-primary">Thay đổi điều khoản</a></li>
            </ul>
          </div>
        </aside>
        ...
        <section className="lg:col-span-9 space-y-12">
          ...
          >
            <p>
              Bằng việc truy cập và sử dụng nền tảng ICS Learning, bạn xác nhận
              rằng mình đã đọc, hiểu và đồng ý với toàn bộ điều khoản sử dụng này.
            </p>
          </AnimatedSection>
          ...
          >
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Tôn trọng giảng viên và các học viên khác.</li>
            </ul>
          </AnimatedSection>
          ...
          >
            <p>
              Trong trường hợp phát hiện hành vi vi phạm, ICS Learning có quyền
              tạm khóa hoặc chấm dứt tài khoản mà không cần báo trước.
            </p>
          </AnimatedSection>
          ...
          >
            <p>
              Chúng tôi có thể cập nhật điều khoản sử dụng theo thời gian.
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-gray-600">
                Nếu bạn cần làm rõ thêm về các điều khoản sử dụng, hãy liên hệ với chúng tôi.
              </p>
              <Link
                href="/lien-he"
