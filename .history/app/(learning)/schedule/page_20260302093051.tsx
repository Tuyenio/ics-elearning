        ...
        {editingItem && (
          <>
            ...
            <motion.div
              ...
              className={`fixed top-0 left-0 right-0 lg:top-auto lg:top-1/2 lg:-translate-y-1/2 z-50 w-full lg:w-full lg:max-w-lg ${
                editingItem.status === 'todo' 
                  ? 'lg:left-1/4 lg:-translate-x-1/2 xl:left-[16.66%]' :
                editingItem.status === 'in-progress' 
                  ? 'lg:left-3/4 lg:-translate-x-1/2 xl:left-1/2' :
                'lg:left-1/4 lg:-translate-x-1/2 xl:left-[83.33%]'
              }`}
              onClick={(e) => e.stopPropagation()}
            >
