        ...
        {editingItem && (
          <>
            ...
            <motion.div
              ...
              className={`fixed z-50 w-full lg:w-full lg:max-w-lg lg:left-1/2 lg:-translate-x-1/2 lg:top-0 ${
                editingItem.status === 'todo' ? 'top-0 left-1/2 -translate-x-1/2' :
                editingItem.status === 'in-progress' ? 'top-1/3 left-1/2 -translate-x-1/2 sm:top-1/3' :
                'top-2/3 left-1/2 -translate-x-1/2 sm:top-2/3'
              }`}
              onClick={(e) => e.stopPropagation()}
            >
