  ...
  return (
    <div className="flex flex-col xl:flex-row gap-4 sm:gap-5 lg:gap-5 xl:gap-4 min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-4 sm:p-5 lg:p-6 xl:p-6">
      ...
      <div className="flex-1 w-full xl:flex-[3] min-w-0">
        ...
        {/* Kanban Columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-4 xl:gap-5">
          {(['todo', 'in-progress', 'completed'] as const).map((status) => (
            ...
            >
              ...
              {/* Cards Container */}
              <div className="flex flex-col gap-3 h-[350px] sm:h-[400px] lg:h-[480px] xl:h-[560px] bg-card/50 dark:bg-slate-800/30 rounded-2xl p-3 sm:p-4 lg:p-5 border border-border/50 dark:border-slate-700/50 overflow-y-auto">
      ...
      <motion.div
        ...
        className="w-full md:w-full lg:w-80 xl:w-[420px] space-y-4 sm:space-y-5 lg:space-y-6"
      >
        {/* Calendar */}
