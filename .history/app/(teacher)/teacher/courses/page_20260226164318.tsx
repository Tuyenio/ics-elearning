...
{menuCourse && menuRect && typeof window !== "undefined" &&
  ...
  {viewMode === "view" && selectedCourse && typeof window !== "undefined" && window.innerWidth < 768 &&
  createPortal(
    <>
      {/* Backdrop */}
      <div
      ...
      {/* Modal */}
      <div className="fixed inset-0 z-[100001] flex items-start justify-center px-4 pt-16 pb-6">
        <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-2xl shadow-2xl w-full max-w-md max-h-[85vh] overflow-y-auto animate-fadeIn">
          ...
          {/* Content – giữ nguyên nội dung bạn đang dùng */}
          <div className="p-4">
            {/* copy toàn bộ phần content chi tiết hiện tại vào đây */}
          </div>
        </div>
      </div>
    </>,
