                ...
                <div className="bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg flex items-center justify-between h-36">
                  <div className="min-h-screen w-full">
                    <div className="w-full space-y-8">
                      ...
                      {/* Payments Card Layout (Mobile) */}
                      <div className="block md:hidden space-y-4">
                        {filteredPayments.length === 0 ? (
                          <div className="p-12 text-center">
                            <CreditCard size={48} className="mx-auto text-muted-foreground dark:text-slate-600 mb-4" />
                            ...
                            >
                              ...
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex-1">
                                  <p className="font-semibold text-white leading-snug line-clamp-2">{payment.user}</p>
                                  <p className="text-xs text-slate-400 mt-1 break-all">{payment.userEmail}</p>
                                </div>
                                <div className="flex flex-col gap-1 items-end shrink-0">
                                  <span className="px-2 py-1 rounded-full text-xs font-medium bg-blue-500/10 text-blue-500 border border-blue-500/20">{payment.method}</span>
                              ...
                              <div className="text-sm text-slate-300 flex items-center gap-2">
                                <span className="font-medium">{payment.teacher}</span>
                                <span className="text-slate-500 text-xs truncate">{payment.teacherEmail}</span>
                              </div>
                      ...
                      <div className="hidden md:block bg-card dark:bg-slate-900/60 border border-border rounded-2xl overflow-hidden">
