...
>
  Xem chi tiết
          ...
          <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto relative z-[10000]">
            ...
            <div className="p-6">
              <table className="w-full text-sm">
                <tbody>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã giao dịch</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.id}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Người dùng</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.user}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Email</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.userEmail}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Số điện thoại</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.userPhone}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Khóa học</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.course}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã khóa học</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.courseId}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Giảng viên</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.teacher}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Email giảng viên</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.teacherEmail}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Số tiền</td>
                    <td className="py-2 text-primary dark:text-accent font-bold">₫{formatPrice(selectedPayment.amount)}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Phương thức</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.method}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Trạng thái</td>
                    <td className="py-2">
                  ...
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Ngày thanh toán</td>
                    <td className="py-2 text-foreground dark:text-white">{formatDate(selectedPayment.date)}</td>
                  </tr>
                  <tr>
                    <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã tham chiếu giao dịch</td>
                    <td className="py-2 text-foreground dark:text-white">{selectedPayment.transactionId}</td>
                  </tr>
                </tbody>
              </table>
              <div className="flex justify-end mt-6">
                <button
                  className="px-6 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary/80 transition-smooth"
                  onClick={() => setSelectedPayment(null)}
                >
                  Đóng
                </button>
      ...
      {/* Thêm popup chi tiết cho tablet/desktop */}
      {expandedPaymentId && (
        (() => {
                ...
                <div className="p-6">
                  <table className="w-full text-sm">
                    <tbody>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã giao dịch</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.id}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Người dùng</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.user}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Email</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.userEmail}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Số điện thoại</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.userPhone}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Khóa học</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.course}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã khóa học</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.courseId}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Giảng viên</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.teacher}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Email giảng viên</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.teacherEmail}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Số tiền</td>
                        <td className="py-2 text-primary dark:text-accent font-bold">₫{formatPrice(payment.amount)}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Phương thức</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.method}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Trạng thái</td>
                        <td className="py-2">
                      ...
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Ngày thanh toán</td>
                        <td className="py-2 text-foreground dark:text-white">{formatDate(payment.date)}</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-semibold text-muted-foreground dark:text-slate-400">Mã tham chiếu giao dịch</td>
                        <td className="py-2 text-foreground dark:text-white">{payment.transactionId}</td>
                      </tr>
                    </tbody>
                  </table>
                  <div className="flex justify-end mt-6">
