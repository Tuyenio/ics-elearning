          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="animate-slideUp" style={{ animationDelay: "0.25s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-6 shadow-lg h-[104px] flex flex-col justify-between">
              ...
              <tbody>
                {filteredPayments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 text-foreground dark:text-white max-w-[260px] truncate">
                      {payment.course}
                    </td>
      ...
      {selectedPayment && (
        <div className="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4">
          <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto relative z-[10000]">
            <div className="sticky top-0 bg-card dark:bg-slate-900 border-b border-border dark:border-slate-800 p-4 flex items-center justify-between">
...
// Remove these unused function stubs
