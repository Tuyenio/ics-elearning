        ...
        <div className="w-full space-y-8">
          ...
          <div className="md:hidden space-y-4">
            {filteredPayments.map((payment) => (
              <div
                key={payment.id}
                className="bg-card dark:bg-slate-900 border border-border rounded-2xl p-4 space-y-3"
              >
                {/* User */}
                <div>
                ...
                <button
                  ...
                  className="pt-2 text-primary flex items-center gap-2 text-sm font-medium"
                >
                  <Eye size={16} />
                  Xem chi tiết
                </button>
