...
export default function AdminPaymentsPage() {
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="animate-slideUp" style={{ animationDelay: "0.25s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-4 sm:p-6 shadow-lg h-[96px] sm:h-[104px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-muted-foreground dark:text-slate-400 text-sm font-medium">Tổng doanh thu</p>
                      <p className="text-xl font-bold text-green-600 dark:text-green-400 mt-1 whitespace-nowrap leading-tight">₫{formatNumber(totalRevenue)}</p>
                    </div>
                ...
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-4 sm:p-6 shadow-lg h-[96px] sm:h-[104px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-yellow-600 dark:text-yellow-400 mt-1 whitespace-nowrap leading-tight">₫{formatNumber(pendingAmount)}</p>
                    </div>
                    <div className="w-10 h-10 flex-shrink-0 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg flex items-center justify-center">
                ...
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-4 sm:p-6 shadow-lg h-[96px] sm:h-[104px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-foreground dark:text-white mt-1 whitespace-nowrap leading-tight">{successCount}</p>
                    </div>
                ...
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-4 sm:p-6 shadow-lg h-[96px] sm:h-[104px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-foreground dark:text-white mt-1 whitespace-nowrap leading-tight">{totalTransactions}</p>
                    </div>
                    <div className="w-10 h-10 flex-shrink-0 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
  ...
  <div className="flex-1 relative">
    ...
    <input
      ...
      className="w-full pl-12 pr-4 py-3 bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
    />
  </div>
  ...
  <div className="flex gap-2 flex-wrap sm:flex-nowrap">
    {[
      ...
      <button
        ...
        className={`px-3 py-2 sm:px-4 sm:py-3 rounded-lg transition-smooth font-medium ${
          statusFilter === option.value
            ? "bg-primary text-white"
            : "bg-card dark:bg-slate-900 border border-border dark:border-slate-800 text-foreground hover:bg-secondary"
        }`}
      >
        {option.label}
      </button>
        ...
        {/* Payments Table */}
        <p className="sm:hidden text-xs text-muted-foreground px-2">Vuốt ngang để xem bảng giao dịch →</p>
        <div className="hidden sm:block bg-card dark:bg-slate-900/60 border border-border dark:border-slate-800 rounded-2xl overflow-hidden">
