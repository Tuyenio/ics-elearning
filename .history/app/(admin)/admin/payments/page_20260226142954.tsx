      ...
      >
        ...
        ">
          ...
          <div className="p-4 space-y-3 text-sm">
            <div>
              <p className="text-slate-400 text-xs">Người mua</p>
              <p className="text-white font-medium">{payment.user}</p>
            </div>

            <div>
              <p className="text-slate-400 text-xs">Khóa học</p>
              <p className="text-white">{payment.course}</p>
            </div>

            <div className="flex justify-between">
              <div>
                <p className="text-slate-400 text-xs">Số tiền</p>
...
{selectedPayment && (
  ...
  >
    ...
    >
      {/* HEADER */}
      <div className="sticky top-0 bg-transparent border-b border-white/10 p-6 flex items-center justify-between">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="text-center">
          <p className="text-slate-400 text-sm">Mã giao dịch</p>
          <p className="text-xl font-bold text-white">{selectedPayment.id}</p>
          <span
            className={`inline-flex px-4 py-1.5 mt-2 rounded-full text-xs font-semibold border ${
        ...
        <div className="bg-[#0E2236] rounded-2xl p-6 text-center border border-cyan-400/20">
          <p className="text-slate-400 text-sm">Số tiền thanh toán</p>
        ...
        <div className="bg-white/5 rounded-xl p-4">
          <p className="text-slate-400 text-sm mb-1">Người mua</p>
        ...
        {/* COURSE */}
        <div className="bg-white/5 rounded-xl p-4">
          <p className="text-slate-400 text-sm mb-1">Khóa học</p>
          <p className="text-white font-medium">{selectedPayment.course}</p>
          <p className="text-slate-400 text-sm">Giảng viên: {selectedPayment.teacher}</p>
        </div>

        {/* META */}
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white/5 rounded-xl p-4">
            <p className="text-slate-400 text-xs">Phương thức</p>
            <p className="text-white font-medium">{selectedPayment.method}</p>
          </div>
          <div className="bg-white/5 rounded-xl p-4">
            <p className="text-slate-400 text-xs">Ngày thanh toán</p>
