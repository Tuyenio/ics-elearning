...
<div className="block lg:hidden space-y-4 mb-6">
  ...
  <div className="mt-3 rounded-xl bg-slate-900 border border-slate-700 p-4 space-y-3 animate-slideDown">
    <div className="flex justify-between items-center">
      <p className="text-sm font-semibold text-white">Chi tiết giao dịch</p>
      <button
    ...
    <div className="text-sm space-y-2 text-slate-300">
      ...
      <div>
        <span className="text-slate-400">Email GV:</span>{" "}
