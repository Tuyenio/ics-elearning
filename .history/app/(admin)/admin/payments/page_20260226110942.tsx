              ...
              <div className="animate-slideUp" style={{ animationDelay: "0.25s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 rounded-2xl p-6 shadow-lg h-36 flex flex-col justify-between items-center">
                  <div className="flex flex-col items-center w-full">
                    ...
                    <p className="text-lg sm:text-xl font-bold text-green-600 whitespace-nowrap leading-tight">
  ₫{formatNumber(totalRevenue)}
</p>
                  </div>
                  <div className="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mt-2">
