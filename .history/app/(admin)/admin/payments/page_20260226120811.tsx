            ...
            <div className="bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto relative z-[10000]">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="text-center pb-4 border-b border-border dark:border-slate-800">
                  ...
                  <p className="text-2xl font-bold text-foreground dark:text-white">{expandedPaymentId}</p>
                  <span
                    className={`inline-block px-3 py-1 rounded-full text-xs font-medium mt-2 ${
                      expandedPaymentId.status === "success"
                        ? "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400"
                        : expandedPaymentId.status === "pending"
                          ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400"
                          : "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400"
                    }`}
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-medium text-foreground dark:text-white">{expandedPaymentId.user}</p>
                    <p className="text-xs text-muted-foreground dark:text-slate-400">{expandedPaymentId.userEmail}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Khóa học</p>
                    <p className="font-medium text-foreground dark:text-white">{expandedPaymentId.course}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Giảng viên</p>
                    <p className="font-medium text-foreground dark:text-white">{expandedPaymentId.teacher}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Số tiền</p>
                    <p className="font-bold text-primary dark:text-accent">₫{formatPrice(expandedPaymentId.amount)}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Phương thức</p>
                    <span className="px-2 py-1 bg-secondary dark:bg-slate-800 rounded text-foreground dark:text-white text-xs font-medium">
                      {expandedPaymentId.method}
                    </span>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Ngày</p>
                    <p className="text-foreground dark:text-white">{formatDate(expandedPaymentId.date)}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Mã giao dịch</p>
                    <p className="text-foreground dark:text-white">{expandedPaymentId.transactionId}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Số điện thoại</p>
                    <p className="text-foreground dark:text-white">{expandedPaymentId.userPhone}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground dark:text-slate-400 text-sm">Email giảng viên</p>
                    <p className="text-foreground dark:text-white">{expandedPaymentId.teacherEmail}</p>
                  </div>
                </div>
              </div>
            </div>
