          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="animate-slideUp" style={{ animationDelay: "0.25s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col items-center justify-center h-36">
              ...
              <div className="animate-slideUp" style={{ animationDelay: "0.35s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col items-center justify-center h-36">
                  <Clock size={32} className="text-yellow-500 mb-2" />
                  <div className="text-lg font-bold text-yellow-700 dark:text-yellow-400">
                    ₫{formatPrice(pendingAmount)}
                  </div>
                  <div className="text-xs text-muted-foreground mt-1">Đang chờ xử lý</div>
                </div>
              </div>
              <div className="animate-slideUp" style={{ animationDelay: "0.45s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col items-center justify-center h-36">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">Giao dịch thành công</div>
                </div>
              </div>
              <div className="animate-slideUp" style={{ animationDelay: "0.55s" }}>
                <div className="bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-4 sm:p-6 shadow-lg flex flex-col items-center justify-center h-36">
                  <CreditCard size={32} className="text-purple-500 mb-2" />
                  <div className="text-lg font-bold text-purple-700 dark:text-purple-400">
                    {totalTransactions}
                  </div>
                  <div className="text-xs text-muted-foreground mt-1">Tổng giao dịch</div>
                </div>
              </div>
            </div>
          </div>
