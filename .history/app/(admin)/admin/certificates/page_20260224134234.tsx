    ...
    <div className="min-h-screen w-full">
      ...
      {approveModalOpen && approveTarget && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/30">
          <div className="bg-card border rounded-2xl shadow-2xl p-5 w-full max-w-md mx-auto">
      ...
      {selectedCertificate && viewMode === null && viewDetailModalOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/30">
          <div className="bg-card border rounded-2xl shadow-2xl p-5 w-full max-w-md mx-auto">
      ...
      {selectedCertificate && viewMode === "reject" && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/30">
          <div className="bg-card border border-red-200 dark:border-red-800 rounded-2xl shadow-2xl p-5 w-full max-w-md mx-auto">
