...
export default function AdminCertificatesPage() {
  ...
  const [approveModalOpen, setApproveModalOpen] = useState(false)
            // Clean up: Remove all unmatched fragments and ensure only valid JSX in main return block
            // The main return block should start here
            return (
              <div className="min-h-screen w-full">
                {/* ...existing admin certificate page JSX... */}
              </div>
            )
