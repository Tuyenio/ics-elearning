              ...
              <div className="w-full space-y-8">
                ...
                <div className="relative overflow-hidden p-8 rounded-3xl animate-fadeIn" style={{ backgroundImage: "url('/image/bg_certificate3.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
                  ...
                  <div className="relative z-10 space-y-8">
                    ...
                    {/* Stats Cards - responsive: 2 cols on mobile, 5 cols on md+ */}
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      {/* ...existing code for each stat card... */}
                    </div>
                  </div>
                </div>
                {/* Search & Filter */}
                  ...
                  {isLoading ? (
                    ...
                    <div className="p-6">
                      {filteredCertificates.length === 0 ? (
                        ...
                        // Card grid: 1 col mobile, 2 col md (tablet), 3 col xl (desktop)
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                          {filteredCertificates.map((cert) => (
                            // ...existing code for each certificate card...
                          ))}
                        </div>
                      )}
                    </div>
