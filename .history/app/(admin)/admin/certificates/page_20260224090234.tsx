...
export default function AdminCertificatesPage() {
    ...
    const fetchExams = async () => {
      try {
        ...
        // Removed normalizeList function as it is no longer needed
    load()
    return () => {
      isMounted = false
    }
    ...
    const handleApprove = async () => {
      ...
      // Clean slate: valid structure, overlay logic, admin actions
      // ...existing state and utility hooks...
      // ...fetch logic, handlers, and UI blocks...
      return (
        <div className="min-h-screen w-full">
          {/* TODO: Restore admin certificate card grid, overlay panel, modal logic, and admin actions here. */}
        </div>
      )
                            {cert.logoUrl ? (
                              <img
