...
export default function AdminCertificatesPage() {
  const [searchTerm, setSearchTerm] = useState("")
                    ...
                    >
                      ...
                      {/* Floating panel beside card */}
                      {selectedCertificate?.id === cert.id && (viewMode === "view" || viewMode === "reject") && (
                        <div
                          className={`absolute top-0 left-full ml-4 w-[340px] max-w-[90vw] z-50 bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-2xl shadow-2xl p-4 animate-fadeIn`}
                        >
                          {viewMode === "view" && (
                            <>
                              <div className="flex items-start justify-between gap-3">
