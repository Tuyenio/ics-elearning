  ...
  Hành động
              ...
              <tbody>
                {filteredCourses.map((course) => (
                  ...
                  >
                    <td className="py-4 px-6 min-w-[260px]" data-label="Khóa học">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-foreground dark:text-white font-medium whitespace-normal truncate" title={course.title}>{course.title}</p>
