            ...
            <table className="w-full min-w-[900px] text-sm table-fixed">
              <thead>
                <tr className="border-b border-border dark:border-slate-800 bg-white/50 dark:bg-slate-800/50">
                  ...
                  <th className="px-6 py-4 min-w-[120px] text-left font-semibold text-foreground dark:text-white">Giá</th>
                  <th className="px-6 py-4 min-w-[100px] text-left font-semibold text-foreground dark:text-white">Học viên</th>
                  ...
                  >
                    <td className="py-4 px-6" data-label="Khóa học">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <p className="text-foreground dark:text-white font-medium line-clamp-2 break-normal whitespace-normal">{course.title}</p>
