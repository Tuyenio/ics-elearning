            ...
            <table className="w-full min-w-[900px] text-sm table-fixed">
              <thead>
                <tr className="border-b border-border dark:border-slate-800 bg-white/50 dark:bg-slate-800/50">
                  ...
                  <th className="sticky right-0 z-20 min-w-[140px] bg-white/90 dark:bg-slate-900/90 backdrop-blur
               text-left py-4 px-6 font-semibold text-foreground dark:text-white">
  Hành động
</th>
                </tr>
              </thead>
              <tbody>
                {filteredCourses.map((course) => (
                  ...
                  >
                    ...
                    <td
  className="sticky right-0 z-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur
             py-4 px-6 relative"
