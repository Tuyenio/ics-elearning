  ...
  Hành động
              ...
              <tbody>
                {filteredCourses.map((course) => (
                  ...
                  >
                    <td className="py-4 p5x-6" data-label="Khóa học">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col justify-center">
                          <p className="text-foreground dark:text-white font-medium whitespace-normal truncate text-left" title={course.title}>{course.title}</p>
                          <p className="text-muted-foreground dark:text-slate-400 text-xs text-left">{course.lessons} bài học • {course.duration}</p>
                        </div>
                      </div>
                    </td>
