          ...
          {filteredUsers.map((user) => (
            ...
            >
              ...
              {mobileEditUserId === user.id && (
                <>
                  <div className="fixed inset-0 z-[99999]" onClick={() => setMobileEditUserId(null)} />
                  <div className="absolute inset-x-0 top-full mt-3 z-[99999]">
                    <div className="bg-card dark:bg-slate-900 border border-border rounded-2xl shadow-xl max-h-[80vh] overflow-y-auto">
                      <EditUserModal
                        user={user}
