...
// Định nghĩa type cho payload thêm user
type AddUserPayload = {
  name: string
  email: string
  phone?: string
                        ...
                        >
                          ...
                          >
                            {filteredUsers.map((user) => (
                              <div
                                key={user.id}
                                className="user-card bg-white/80 dark:bg-slate-900/70 border border-border dark:border-slate-800 rounded-2xl p-4 shadow-sm mb-2"
                              >
                                {/* Avatar + Name */}
                                ...
                                {/* Actions - stick to card bottom right on mobile */}
