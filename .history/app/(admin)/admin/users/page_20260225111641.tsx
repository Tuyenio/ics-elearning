          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <div className="relative">
              <select
                ...
                className={`appearance-none px-4 py-2 rounded-xl font-medium transition-all duration-300 min-w-[140px] text-sm
                  ${selectedRole === 'all' ? 'bg-gradient-to-r from-primary to-accent text-white shadow-md shadow-primary/30' : 'bg-white dark:bg-slate-800 border-2 border-border/60 dark:border-slate-700 text-foreground dark:text-white hover:border-primary/50 dark:hover:border-accent/50 hover:shadow-md'}
                `}
                style={{ backgroundPosition: 'right 0.75rem center', backgroundRepeat: 'no-repeat', backgroundSize: '1.25em', backgroundImage: 'url("data:image/svg+xml,%3Csvg fill=\'none\' stroke=\'%23333\' stroke-width=\'2\' viewBox=\'0 0 24 24\'%3E%3Cpath d=\'M6 9l6 6 6-6\'/%3E%3C/svg%3E")' }}
              >
            ...
            <div className="relative">
              <select
                ...
                className={`appearance-none px-4 py-2 rounded-xl font-medium transition-all duration-300 min-w-[160px] text-sm
                  ${selectedStatus === 'all' ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md' : 'bg-white dark:bg-slate-800 border-2 border-border/60 dark:border-slate-700 text-foreground dark:text-white hover:border-emerald-400/50 hover:shadow-md'}
                `}
                style={{ backgroundPosition: 'right 0.75rem center', backgroundRepeat: 'no-repeat', backgroundSize: '1.25em', backgroundImage: 'url("data:image/svg+xml,%3Csvg fill=\'none\' stroke=\'%23333\' stroke-width=\'2\' viewBox=\'0 0 24 24\'%3E%3Cpath d=\'M6 9l6 6 6-6\'/%3E%3C/svg%3E")' }}
              >
