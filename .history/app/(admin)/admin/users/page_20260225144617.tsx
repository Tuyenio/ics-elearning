                ...
                {filteredUsers.map((user) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 relative z-50">
                      ...
                      {openMenu === user.id && (
                        <div className="absolute right-0 top-full mt-2 z-[1050] bg-card dark:bg-slate-900 border border-border dark:border-slate-800 rounded-lg shadow-lg min-w-48">
