              ...
              <tbody>
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="border-b border-border dark:border-slate-800 hover:bg-white/60 dark:hover:bg-slate-800/60 transition-all duration-300">
                    ...
                    {/* MOBILE CARD */}
                    <div className="md:hidden w-full max-w-md mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow border border-border dark:border-slate-800 overflow-hidden my-3">
                    ...
                    <>
                      ...
                      <td className="hidden md:table-cell py-4 px-6 text-foreground dark:text-white">{user.courses || "Chưa cập nhật"}</td>
                      <td className="hidden md:table-cell py-4 px-6 text-muted-foreground dark:text-slate-400">{user.createdAt ? formatDate(user.createdAt) : "Chưa cập nhật"}</td>
                      <td className="hidden md:table-cell py-4 px-6">
                        <span
                      ...
                      <td className="hidden md:table-cell py-4 px-6 relative">
                        <button
                          onClick={() => setOpenMenu(openMenu === user.id ? null : user.id)}
                          className="p-2 hover:bg-secondary dark:hover:bg-slate-800 rounded-lg transition-smooth"
                        >
