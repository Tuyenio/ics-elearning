        ...
        <div className="lg:hidden space-y-4">
          {filteredUsers.map((user) => (
            ...
            >
              ...
              {/* Modal Sửa neo card */}
              {mobileEditUserId === user.id && (
                <>
                  {/* Backdrop overlay with blur and darken */}
                  <div className="fixed inset-0 z-[99999] bg-black/60 backdrop-blur-sm" onClick={() => setMobileEditUserId(null)} />
                  <div className="absolute inset-x-0 top-full mt-3 z-[99999] flex justify-center">
                    <div className="bg-card dark:bg-slate-900 border border-border rounded-2xl shadow-2xl max-h-[80vh] overflow-y-auto w-full mx-2 sm:mx-auto sm:max-w-lg relative animate-fadeInUp" style={{ boxShadow: '0 8px 40px 0 rgba(0,0,0,0.25)' }}>
                      <EditUserModal
                        user={user}
