          ...
          {filteredUsers.map((user) => (
            ...
            >
              ...
              {mobileViewUserId === user.id && (
                <>
                  <div className="fixed inset-0 z-40" onClick={() => setMobileViewUserId(null)} />
                  <div className="absolute inset-x-0 top-full mt-3 z-50">
              ...
              {mobileEditUserId === user.id && (
                <>
                  <div className="fixed inset-0 z-40" onClick={() => setMobileEditUserId(null)} />
                  <div className="absolute inset-x-0 top-full mt-3 z-50">
