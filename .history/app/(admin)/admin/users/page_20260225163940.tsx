                ...
                <div className="bg-secondary dark:bg-slate-800/50 rounded-xl p-4">
                  ...
                  <p className="text-foreground dark:text-white font-medium">
                    {viewUser.lastLoginAt
                      ? formatDate(viewUser.lastLoginAt, "dd/MM/yyyy")
                      : viewUser.createdAt
                        ? `${formatDate(viewUser.createdAt, "dd/MM/yyyy")} (lần đầu)`
                        : "Chưa cập nhật"}
                  </p>
                </div>
              </div>
          ...
          {filteredUsers.map((user) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <InfoRow
                  label="Ngày tham gia"
                  value={user.createdAt ? formatDate(user.createdAt, "dd/MM/yyyy") : "Chưa cập nhật"}
                />
                <InfoRow
                  label="Trạng thái"
                  value={
