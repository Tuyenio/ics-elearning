...
export default function AdminUsersPage() {
  ...
  // For mobile modal (bottom sheet / fullscreen)
  const [mobileUser, setMobileUser] = useState<UserData | null>(null);
  const [mobileMode, setMobileMode] = useState<'view' | 'edit' | null>(null);
      ...
      <div className="w-full space-y-8">
        ...
        <div className="lg:hidden space-y-4">
          {filteredUsers.map((user) => (
            ...
            {/* MOBILE MODAL (bottom sheet / fullscreen) - render ONCE at end of page */}
            {mobileUser && mobileMode === 'view' && typeof window !== 'undefined' && window.innerWidth < 1024 && (
            ...
            {mobileUser && mobileMode === 'edit' && typeof window !== 'undefined' && window.innerWidth < 1024 && (
