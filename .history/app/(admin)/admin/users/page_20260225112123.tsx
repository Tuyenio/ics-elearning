...
function DropdownFilter({ options, value, onChange, className = "", width = 180 }) {
        ...
        <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md border border-border/50 dark:border-slate-800/50 rounded-2xl p-6 space-y-4">
          ...
          <div className="filter-row">
            ...
            <DropdownFilter
              ...
              value={selectedRole}
              onChange={(v: string | ((prevState: "all" | "student" | "teacher" | "admin") => "all" | "student" | "teacher" | "admin")) => setSelectedRole(v)}
              width={160}
            />
            <DropdownFilter
              options={[
              ...
              onChange={(v: string | ((prevState: "all" | "active" | "inactive" | "pending") => "all" | "active" | "inactive" | "pending")) => setSelectedStatus(v)}
              width={180}
            />
          </div>
        </div>
